...
dat_file=/tmp/compact_block_trace/block_cache_hit_rate_change_dur_${branch}_${block_size}_${out_suffix}.txt
...
out_file=/tmp/compact_block_trace/block_cache_get_hit_rate_change_dur_${branch}_${block_size}_${out_suffix}.png
