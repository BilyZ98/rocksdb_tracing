...
trace_analyzer="../build/trace_analyzer"
$trace_analyzer \
  -analyze_get \
...
block_cache_trace_analyzer="../build/block_cache_trace_analyzer_tool"
bct_human_file_path="$trace_data_dir/block_trace_human_file"
...
io_parser_res="$trace_data_dir/io_trace_res"
